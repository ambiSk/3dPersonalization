...
class CropImage:
    ...
    def get_coords(self, landmark, height, width):
        x1 = round(landmark[93].x * width)
        x2 = round(landmark[323].x * width)

        y1 = round(landmark[5].y * height)
        y2 = round(landmark[199].y * height)
...
model_path = "../../Trained_models/dimples_v1.pkl"
if not os.path.exists(model_path):
    os.system("gsutil cp gs://ds-staging-bucket/3D-Hikemoji-pers/trained-models/dimples_v1.pkl " + model_path)
