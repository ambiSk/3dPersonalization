...
import inference_flows.FaceDepthFeatures.cheeklines_v2.csv as cheek_lines
import inference_flows.FaceDepthFeatures.cheek_chubbiness_v3.csv as cheek_chubbiness
import inference_flows.FaceDepthFeatures.cheek_dimples_v1.csv as cheek_dimples
import inference_flows.FaceShape.FaceShape_supervisedmodel_inference.csv as face_shape
import inference_flows.FaceShape.FaceShape_supervisedmodel_inference_female.csv as face_shape_female
import inference_flows.Lips.male.inference.csvs as malelipsinference
import inference_flows.Lips.female.inference.csv as femalelipsinference
import inference_flows.Nose.nose_mp_male_res2.csv as malenoseinference
import inference_flows.Nose.nose_mp_female_res2.csv as femalenoseinference
import inference_flows.Eyes.MaleEyeInfer.csv as MaleEyesinference
import inference_flows.Eyes.FemaleEyeInfer.csv as FemaleEyesinference
import inference_flows.Lips_v2.male.inference.csv as malelipsinference_v2
import inference_flows.Lips_v2.female.inference.csv as femalelipsinference_v2
import inference_flows.Lips_v3.male.inference.csv as malelipsinference_v3
import inference_flows.Lips_v3.female.inference.csv as femalelipsinference_v3
import inference_flows.Outfit.segmentation.csv as outfit_segmentation
import inference_flows.Outfit.color_extractor_v2.csv as color_extractor_v2
from inference_flows import Hikemoji2D.csv as Hikemoji2D
...
def run_inferences():
    ...
    if gender == 'male':
        ...
        face_shape_df = face_shape.main(input_images_path,'./Trained_models/faceshape_trial_male_v2_2_1_xg_faceangles.pkl')
        ...
        face_shape_df = face_shape_female.main(input_images_path,'./Trained_models/faceshape_trial_female_v1.3_xg_faceangles.pkl')
